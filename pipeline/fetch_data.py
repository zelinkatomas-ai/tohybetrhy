...
GROUPS: dict[str, dict] = {
    ...
    "regions_asia": {
        ...
        "note": "Asie v detailu po zemích (velká trojka stejnými fondy jako v hlavní tabulce). U menších trhů americká iShares/VanEck ETF jako indikátor, výnosy v měně fondu.",
        "items": [
            {"ticker": "MCHI",     "name": "Čína"},
            {"ticker": "QDV5.DE",  "name": "Indie"},
            {"ticker": "CSJP.MI",  "name": "Japonsko"},
    ...
    "regions_north_america": {
        "file": "regions_north_america.json",
        "note": "Severní Amerika v detailu. USA stejným fondem jako v hlavní tabulce, Kanada přes americké iShares ETF jako indikátor.",
        "items": [
            {"ticker": "CSPX.AS", "name": "USA (S&P 500)"},
            {"ticker": "EWC",     "name": "Kanada"},
        ],
        "sort_by": "r3",
    },
    "regions_latam": {
        "file": "regions_latam.json",
        "note": "Latinská Amerika v detailu (včetně Mexika). Americká ETF jako indikátor, výnosy v USD. Venezuela nemá investovatelný trh ani ETF.",
        "items": [
            {"ticker": "EWZ",  "name": "Brazílie"},
            {"ticker": "EWW",  "name": "Mexiko"},
            {"ticker": "ECH",  "name": "Chile"},
            {"ticker": "EPU",  "name": "Peru"},
            {"ticker": "ARGT", "name": "Argentina"},
            {"ticker": "GXG",  "name": "Kolumbie"},
        ],
        "sort_by": "r3",
    },
    "crypto": {
